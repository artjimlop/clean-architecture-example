 ...
 */
package com.example.artjimlop.myapplication.model.mapper;
...
public final class ComicModelMapper {
    ...
    @Inject public ComicModelMapper() {
    }

    public ComicModel toModel(Comic bo) {
    ...
    public List<ComicModel> toModel(Collection<Comic> bos) {
